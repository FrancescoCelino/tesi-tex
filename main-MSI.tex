...
\begin{lstlisting}[style=pythonstyle, caption={Initializing the model}, label={code:init}]
...
\begin{lstlisting}[style=pythonstyle, caption={Advancing the simulation by one time step}, label={code:one_step}]
...
\begin{lstlisting}[style=pythonstyle, caption={Vaccination and death count functions}, label={code:death}]
...
\begin{lstlisting}[style=pythonstyle, caption={Defining the parameters class}, label={code:parameters}]
...
\begin{lstlisting}[style=pythonstyle, caption={Retrieves saved memory from previous weeks of simulation}, label={code:memory_load}]
	import pandas as pd
	import glob
	import os
...
\begin{lstlisting}[style=pythonstyle, caption={Saves current state to be used in future simulations}, label={code:memory_save}]
...
\begin{lstlisting}[style=pythonstyle, caption={Bayesian optimization}, label={code:bayes}]
...
\begin{lstlisting}[style=pythonstyle, caption={MCMC iterations}, label={code:mcmc}]
...
\begin{lstlisting}[style=pythonstyle, caption={Non-bayesian optimization}, label={code:optim}]
...
\begin{lstlisting}[style=pythonstyle, caption={Reading Influcast data}, label={code:influcast}]
	'''
