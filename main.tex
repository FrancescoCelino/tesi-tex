...
Explain how we was an unexpectedly high incidence during christmas seasons, and how each model performed poorly in that period. Explain how the bayesian strategy slightly solves the issue. Put a figure showing performance during christmas season of each model (both our two models and influcast models)


\section{Numerical results}

Insert plots and tables for each region, both from our personal figures and from the influcast paper\cite{influcast}
%\begin{figure}[tb!]
%\begin{center}
